...
class PersonalityNumberItem extends StatelessWidget {
  final MainNumber number;

  const PersonalityNumberItem({Key? key, required this.number})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    final nc = NumerologyCalculator();
    final myNumber = nc.personalityNumnber(number.name);
    return Column(
